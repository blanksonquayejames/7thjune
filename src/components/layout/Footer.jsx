      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__col">
            ...
            <Link href="/orders" className="footer__link">My Orders</Link>
          </div>
          <div className="footer__col">
            <h4 className="footer__heading">Categories</h4>
            <Link href="/products?category=computers" className="footer__link">Computers</Link>
            <Link href="/products?category=storage-components" className="footer__link">Storage & Components</Link>
            <Link href="/products?category=networking" className="footer__link">Networking</Link>
            <Link href="/products?category=tablets" className="footer__link">Tablets</Link>
            <Link href="/products?category=peripherals" className="footer__link">Peripherals</Link>
          </div>
          <div className="footer__col">
