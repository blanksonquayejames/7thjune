...
export default function ProfilePage() {
  ...
  return (
    <>
      <div className="page-header"><div className="container"><h1 className="page-header__title">Profile</h1><div className="page-header__breadcrumb"><Link href="/">Home</Link><BsChevronRight style={{ fontSize: '.7rem' }} /><span>Profile</span></div></div></div>
